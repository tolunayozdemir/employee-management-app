...
suite('Validators', () => {
  ...
  suite('validateNotFutureDate', () => {
    test('returns false for future dates', () => {
      ...
      expect(validators.validateNotFutureDate(tomorrow.toISOString())).to.be
        .false;
    });
    ...
    test('returns true for current or past dates', () => {
      ...
      expect(validators.validateNotFutureDate(yesterday.toISOString())).to.be
        .true;
  ...
  suite('validateDateOfBirth', () => {
    test('returns false for future dates', () => {
      ...
      expect(validators.validateDateOfBirth(tomorrow.toISOString())).to.be
        .false;
    });
    ...
    test('returns false for too young ages', () => {
      ...
      expect(validators.validateDateOfBirth(tooYoung.toISOString())).to.be
        .false;
    });
    ...
    test('correctly calculates age when birthday has not occurred yet this year', () => {
      ...
      expect(validators.validateDateOfBirth(birthDate.toISOString())).to.be
        .false;
    });
  ...
  suite('validatePhone', () => {
    test('returns false for invalid phone numbers', () => {
      ...
      expect(validators.validatePhone('1234567890')).to.be.false;
      expect(validators.validatePhone('+1234567890')).to.be.false;
      expect(validators.validatePhone('04521234567')).to.be.false;
      expect(validators.validatePhone('0552123456')).to.be.false;
      expect(validators.validatePhone('055212345678')).to.be.false;
    });

    test('returns true for valid phone numbers or empty', () => {
      expect(validators.validatePhone('05521234567')).to.be.true;
      expect(validators.validatePhone('05321234567')).to.be.true;
      expect(validators.validatePhone('05421234567')).to.be.true;
  ...
  suite('validateEmailUnique', () => {
    test('returns false for duplicate emails', () => {
      ...
      expect(validators.validateEmailUnique('john@example.com', existingEmails))
        .to.be.false;
      expect(validators.validateEmailUnique('jane@example.com', existingEmails))
        .to.be.false;
    });
    ...
    test('returns true for unique emails or empty', () => {
      ...
      expect(validators.validateEmailUnique('new@example.com', existingEmails))
        .to.be.true;
